...
class InvalidName___Class_0x00___Differ_16
end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_17
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_18
