...
class VCR::RequestMatcherRegistry::Matcher < Anonymous_Struct_20
...
class VCR::RequestMatcherRegistry::URIWithoutParamsMatcher < Anonymous_Struct_21
...
class VCR::Request < Anonymous_Struct_22
  def initialize(*args); end
  def method(*args); end
  def parsed_uri; end
...
class VCR::Request::Typed < Anonymous_Delegator_23
...
class VCR::Request::FiberAware < Anonymous_Delegator_24
  def proceed; end
  def to_proc; end
end
...
class VCR::Response < Anonymous_Struct_25
  def compressed?; end
...
class VCR::ResponseStatus < Anonymous_Struct_26
  def self.from_hash(hash); end
  def to_hash; end
end
...
class VCR::HTTPInteraction < Anonymous_Struct_27
  def hook_aware; end
  def initialize(*args); end
  def self.from_hash(hash); end
  def to_hash; end
end
class VCR::HTTPInteraction::HookAware < Anonymous_Delegator_28
